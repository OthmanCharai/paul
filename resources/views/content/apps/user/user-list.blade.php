                  ...
                  render: function (data, type, full, meta) {
                      return (
                        ...
                        '<div class="modal modal-slide-in update-user-modal fade" id="modals-slide-in-update'+ full['id']+'">'+
                            '<div class="modal-dialog">'+
                              '<form method="post" action="/user/'+full['id']+'" class="add-new-user modal-content pt-0">'+
                                '@csrf'+
                                '@method('PUT')'+
                                '<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>'+
                                '<div class="modal-header mb-1">'+
                                ...
                                '<div class="modal-body flex-grow-1">'+
                                  ...
                                  ' <label class="form-label" for="basic-icon-default-fullname">First Name</label>'+
                                    '<input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname" value="'+full['name']+ '" name="name"/>'+
                                ' </div>'+
                                ' <div class="mb-1">'+
                                    '<label class="form-label" for="basic-icon-default-uname">Email</label>'+
                                    '<input type="email" id="basic-icon-default-uname" class="form-control dt-uname" value="'+full['email']+'" name="email"/>'+
                                    '</div>'+         
                                  '<div class="mb-1">'+
                                  '<label class="form-label" for="basic-icon-default-contact">Password</label>' +             
                                      '<input type="password"'+
          ...
          initComplete: function () {
              ...
              this.api()
                  ...
                  .every(function () {
                      var column = this;
                      var label = $(
                          '<label class="form-label" for="UserRole">Email </label>'
                      ).appendTo(".user_role");
                      var select = $(
                          '<select id="UserRole" class="form-select text-capitalize mb-md-0 mb-2"><option value=""> Email  </option></select>'
                      )
                          .appendTo(".user_role")
                          .on("change", function () {
              ...
              this.api()
                  ...
                  .every(function () {
                      var column = this;
                      var label = $(
                          '<label class="form-label" for="UserPlan">Name</label>'
                      ).appendTo(".user_plan");
                      var select = $(
                          '<select id="UserPlan" class="form-select text-capitalize mb-md-0 mb-2"><option value=""> Select Name </option></select>'
                      )
                          .appendTo(".user_plan")
                          .on("change", function () {
                              var val = $.fn.dataTable.util.escapeRegex(
              ...
              this.api()
                  ...
                  .every(function () {
                      var column = this;
                      var label = $(
                          '<label class="form-label" for="UserPlan">Created Date</label>'
                      ).appendTo(".user_status");
                      var select = $(
                          '<select id="FilterTransaction" class="form-select text-capitalize mb-md-0 mb-2xx"><option value=""> Created Date </option></select>'
                      )
                          .appendTo(".user_status")
                          .on("change", function () {
                              var val = $.fn.dataTable.util.escapeRegex(
